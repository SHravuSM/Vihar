...
//   });
//   const [selectedVehicleType, setSelectedVehicleType] = useState("All");
//   const [editingUser, setEditingUser] = useState(null); // Add state to track the user being edited
//   const [userForm, setUserForm] = useState({ name: "", email: "", role: "" }); // Form state for user details
...
//               {/* Edit User Form */}
//               {editingUser === user.id && (
//                 <form onSubmit={handleSubmitUserEdit} className="mt-4">
//                   <div className="space-y-2">
//                     <div>
...
//                   className="rounded bg-blue-500 px-4 py-2 text-white"
//                 >
//                   {expandedUserId === user.id ? "Hide" : "Show"} Vehicles
//                 </button>
...
//                     {sortedVehicles.length === 0 ? (
//                       <p className="text-gray-500">No vehicles found for this user.</p>
//                     ) : (
//                       sortedVehicles.map((vehicle) => (
//                         <div
//                           key={vehicle.id}
...
//   const vehicleCountByType = userVehicles.reduce((count, vehicle) => {
//     count[vehicle.type] = (count[vehicle.type] || 0) + 1;
//     return count;
//   }, {});
...
//               <h3 className="text-lg font-semibold text-gray-800">{user.name}</h3>
//               <p className="text-gray-600">{user.email}</p>
//               <p className="mt-2 text-sm text-gray-500">Provider ID: {user.id}</p> {/* Display Provider ID */}
